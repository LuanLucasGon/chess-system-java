...
public class UI {
    ...
    private static void printCapturedPieces(List<ChessPiece> caoturedPieces){
        List<ChessPiece> white = caoturedPieces.stream().filter(x -> x.getColor() == Color.WHITE).toList();
        List<ChessPiece> black = caoturedPieces.stream().filter(x -> x.getColor() == Color.BLACK).toList();
